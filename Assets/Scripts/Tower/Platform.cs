...
public class Platform : MonoBehaviour
{
    ...
    {
        Vector3 offset = new Vector3(0f, 0.4f, 0f); // chỉnh 0.1 lên/xuống tùy hướng lệch
        Instantiate(data.prefab, transform.position + offset, Quaternion.identity, transform);
    }
}
